  ...
  return (
    <section className= {`bg-black text-white font-proxima text-lg flex justify-center items-center transform transition-transform duration-[400ms] ease-in ${showNav ? '' : "-translate-y-full"} md:h-24 h-16 w-full`}>
      ...
      <div className='flex justify-center items-center  w-full flex-col'>
        ...
        <div className={`mobileMenu top-[64px] xsm:top-[4rem] text-black absolute ${mobileMenu ? 'block' : 'hidden'} md:hidden transform transition-transform duration-300 ease-in-out ${mobileMenu ? '' : ''} w-full flex justify-center items-center`}>
